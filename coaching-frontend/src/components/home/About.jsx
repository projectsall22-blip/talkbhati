      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-3 text-sm md:text-base">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={label} className="flex items-center gap-2.5 rounded-xl px-3 py-2.5 border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
            ...
            <div className="relative w-full max-w-xs sm:max-w-sm">
              <div className="rounded-3xl overflow-hidden shadow-xl"
                ...
                <img src={founderImg} alt="Mazid Ali Khan"
                  className="w-full h-60 sm:h-72 object-cover object-top" />
              ...
              <div className="absolute -top-3 -right-2 sm:-right-3 rounded-2xl px-3 py-2 shadow-lg text-white text-xs font-bold"
